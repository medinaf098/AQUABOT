<div class="d-xl-flex" style="width: 100%;" id="portada">
    <div class="d-xl-flex align-items-xl-center header-dark"
                        ...
                        width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
                         ...
                         center;">
                                    ...
                                    <p style=" margin:8px 0 0 0; padding:0 4px;"> <a
                                            ...
                                            target="_blank">Que la vida valga la pena</a></p>
                                    <p
                                        style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">
                                        Una publicación compartida de <a
                                            href="https://www.instagram.com/medinaf98/?utm_source=ig_embed&amp;utm_campaign=loading"
                                            style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px;"
                                            target="_blank"> Agustin Medina</a> (@medinaf98) el <time
                                            style=" font-family:Arial,sans-serif; font-size:14px; line-height:17px;"
                                            datetime="2018-11-20T20:52:41+00:00">20 Nov, 2018 a las 12:52 PST</time></p>
                                </div>
                            </blockquote>
